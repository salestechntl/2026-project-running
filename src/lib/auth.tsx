...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const applyUser = useCallback((emp: Employee, lead: boolean, superAdmin: boolean) => {
    setUser(emp);
    setIsLead(lead);
  ...
  return (
    <AuthContext.Provider value={{ user, isLead, isSuperAdmin, loading, authMode, login, logout }}>
      {children}
