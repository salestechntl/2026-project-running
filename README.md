...
> **โหมดสาธิต:** `SIMULATED_CURRENT_MONTH = "2026-09"` ใน [missions.ts](src/lib/missions.ts) ใช้บังคับ “เดือนปัจจุบัน” เพื่อพรีวิวการปลดล็อก (ก.ค.–ก.ย. เปิด, ต.ค.–ธ.ค. ล็อก) — **ก่อนใช้งานจริงตั้งค่าเป็น `""`** เพื่ออ้างอิงวันที่จริง
